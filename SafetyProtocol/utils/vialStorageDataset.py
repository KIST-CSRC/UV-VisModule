...
class vialStorageDataset(Dataset):
...
def demo():
    image_dir = '/media/leslie/Local Disk/Nature Comm(Vial Detection)/vial-detection-SSD/dataset/Video/'
    label_txt = '../vialStorage.txt'
    dataset = vialStorageDataset(image_dir, label_txt, training=True, debug=True)
